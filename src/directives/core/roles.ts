 ...
 * <template>
 *   <!-- 单个角色 - 只有平台管理员可见 -->
 *   <el-button v-roles="'platform_admin'">平台管理员功能</el-button>
 *
 *   <!-- 多个角色 - 平台管理员或团队管理员可见 -->
 *   <el-button v-roles="['platform_admin', 'team_admin']">管理员功能</el-button>
 *
 *   <!-- 应用到任意元素 -->
 *   <div v-roles="['platform_admin', 'team_admin', 'member']">
 *     所有登录用户可见的内容
 *   </div>
 * </template>
 * ```
