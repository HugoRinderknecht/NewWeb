...
// 业务域当前项目 ID（统一数据层入口，可写版）
export { useWritableProjectId } from './core/useCurrentProjectId'
...
// 注意：useCurrentProjectId 已重命名为 useWritableProjectId（可写版）
// 只读版本请使用 useCurrentContext(domain).projectId
